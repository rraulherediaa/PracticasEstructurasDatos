...
class Program
{
    static void Main(string[] args)
    {
        ...
        int cantidadEnteros = int.Parse(Console.ReadLine());
        ...
        int cantidadStrings = int.Parse(Console.ReadLine());
        ...
        int cantidadDesapilar = int.Parse(Console.ReadLine());
        ...
        int cantidadGrande = int.Parse(Console.ReadLine());
        ...
        Console.Write("¿Cuántos elementos desea desapilar? ");
        int cantidadDesapilarGrande = int.Parse(Console.ReadLine());
        ...
        Console.Write("Ingrese cantidad de elementos a apilar: ");
        int cantidadLimpiar = int.Parse(Console.ReadLine());
